...
// Создать переменную item_2 и присвоить ей цифру 3
 ...
 console.log (item_2);
//  Создать переменую item_3, присвоить ей сложение item_1 и item_2
 let item_3 = item_1 + item_2;
 // Вывести в консоль item_3
 console.log(item_3);
 // Создать переменную item_2 и присвоить ей строку "Yolochka"
 let item_4 = "Yolochka";
 ...
 let item_5 = item_3;
  // Создать переменную item_5 и присвоить ей значение 15
 let item_6 = 15;
...
//  Создать переменную Item_7 и в ней приобразовать Item_6 в String
 let item_7 = 'item_6'
...
if (age_1<age_2){
    console.log("You don't have access cause yiur age is" + age_1 + "It's less then")}
